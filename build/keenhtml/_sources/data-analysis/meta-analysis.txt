...
* :ref:`saved-query-list-resource` - Returns all the available :doc:`saved-queries` in this project as well as links to each of their :ref:`saved-query-row-resource`.
