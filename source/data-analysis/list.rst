...
.. code-block:: none
    ...
    https://api.keen.io/3.0/projects/<project_id>/queries/select_unique?api_key=<key>&event_collection=<event_collection>&target_property=<property>
...
.. code-block:: none
    ...
    https://api.keen.io/3.0/projects/<project_id>/queries/select_unique?event_collection=logins&api_key=<api_key>&target_property=user.email
