...
Unlike traditional databases like SQL, our database has no schema. You no longer need to think of data as a row with a limited number of columns. Our database holds JSON documents - they’re hierarchical and can have as many fields and values as you want.  If you're new to unstructured data, take a look at the :doc:`../event_data_modeling/event_data_intro` to get some ideas about how to model the data you send to Keen.